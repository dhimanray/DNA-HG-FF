...
cd /oasis/tscc/scratch/dray1/dhiman/DNA-Hoogsteen/DNA/minimization
#module load 
/home/dray1/NAMD_2.12_Linux-x86_64-multicore-CUDA/namd2 +idlepoll +isomalloc_sync +p 4 minimization.conf > minimization.log
